...
const STORAGE_SAVED_PEER_KEY = 'usagi_paired_peer_target'; // 영구 연결 파트너 키
...
// 자동 재접속 루프 (상대방이 켜질 때까지 백그라운드에서 연결 유지)
