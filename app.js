...
// 🔔 시계를 터치했을 때 아이폰/안드로이드 알림 권한 팝업 실행
const koreaClockEl = document.getElementById('koreaClock');
koreaClockEl.addEventListener('click', () => {
  playPopSound();
...
function updateKoreaTime() {
  ...
  // 터치 유도를 위해 시계 중앙 텍스트 반영
  koreaClockEl.innerText = timeString;
}
