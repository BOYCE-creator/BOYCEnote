...
// 사운드 엔진 (전체지우기: yaha.mp3 / 호출: call.mp3)
let audioCtx = null;
...
// 🔔 호출 버튼 (앱 켜짐: P2P 단일 호출 / 앱 꺼짐: FCM 백그라운드 푸시)
