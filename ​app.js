// ==========================================
// 🔔 Cloudflare 24시간 백그라운드 푸시 중계 연동
// ==========================================
...
const STORAGE_CANVAS_KEY = 'usagi_drawing_data_v4';
...
// 🔔 호출 버튼 (실시간 P2P 전송 + 앱 종료 시 Cloudflare 중계 서버를 통한 FCM 24시간 백그라운드 푸시)
callBtn.addEventListener('click', async () => {
  ...
  if (targetToken) {
    try {
      ...
      console.warn('Cloudflare Relay Error:', e);
    }
  }
